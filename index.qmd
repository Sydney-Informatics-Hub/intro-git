...
This course is adapted from [Version Control with Git](https://swcarpentry.github.io/git-novice) by staff from the Sydney Informatics Hub (Michael Lynch, with help from Darya Vanichkina). 
